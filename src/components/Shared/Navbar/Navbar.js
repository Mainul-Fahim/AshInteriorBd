...
const NavBar = () => {
    ...
    return (
        <Navbar className={`navbar navbar-expand-lg navbar-dark ${isSticky ? "navStyle": "navDefault"}`} expand="lg">
            <Container>
                <Navbar.Brand as={Link} exact to="/" onClick={scrollTop} className="navBrn">
                    {/* <FontAwesomeIcon icon={faIntercom} className="brnIcon"/> */}
                    <img style={{width: '100%', height: '90px'}} src={logo} alt="" loading="lazy" />
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto mainNav" activeKey="/home">
                        ...
                        <Nav.Item>
                            <Nav.Link href="#testimonial" className="nav-link">Projects</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link href="#contact" className="nav-link">Contact Us</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link as={Link} to="/dashboard/addHeader" className="nav-link">Dashboard</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            {
                            user.email ? 
