...
const AddGallery = ({edit, setEdit, gallery}) => {
    ...
    const onSubmit = data => {
        ...
        if(edit){
            axios.put(`https://backend.ashinteriorbd.com/api/gallery/v1/gallery/update/${edit}`, headerInfo)
            .then(res =>{
            ...
            axios.post('https://backend.ashinteriorbd.com/api/gallery/v1/gallery/add', headerInfo)
            .then(res => {
                toast.dismiss(loading)
                if(res.data){
