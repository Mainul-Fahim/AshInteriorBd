...
const AddService = ({edit, setEdit, services}) => {
    ...
    const onSubmit = data => {
        ...
        if(edit){
            axios.put(`https://backend.ashinteriorbd.com/api/product/v1/product/update/${edit}`, serviceInfo)
            .then(res =>{
            ...
            axios.post('https://backend.ashinteriorbd.com/api/product/v1/product/add', serviceInfo)
            .then(res => {
                toast.dismiss(loading)
                if(res.data){
